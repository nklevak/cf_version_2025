...
1. with an overall average accuracy below 30% on both tasks (digit span and spatial recall) as this signifies a lack of attention/trying
...
- Prolific has a feature that auto-rejects responses they believe are not humanly possible
- looking at our previous pilot with 84 participants, the minimum response time with non-excluded data was: ______ so we will use that as a lower boundary for exclusion.
